...
public class APIModuleDemo extends UZModule {
	...
	/**
	 * <strong>属性</strong><br><br>
	 * 该函数映射至Javascript中moduleDemo对象的version属性<br><br>
	 * <strong>JS Example：</strong><br>
	 * 
	 * alert(moduleDemo.version);
	 * 
	 * @param moduleContext  (Required)
	 */
	...
	/**
	 * <strong>属性</strong><br><br>
	 * 该函数映射至Javascript中moduleDemo对象的model属性<br><br>
	 * <strong>JS Example：</strong><br>
	 * 
	 * alert(moduleDemo.model);
	 * 
	 * @param moduleContext
	 */
	@UzJavascriptProperty
